...
insert into planets (name, ownerId, image) values ('Amphitrite Euphrosyne Virginia', 1, ?);
...
insert into moons (name, myPlanetId, image) values ('waxing crescent gibbous Moon!!', 2, ?);
